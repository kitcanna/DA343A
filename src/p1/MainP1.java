...
public class MainP1 {
	public static void main(String[] args) {
		...
		ipManager.addMessageProducer(getArrayProducer(2,100)); 	//(how many times the sequence shall run, delay between each object)
		ipManager.addMessageProducer(new ShowGubbe(1000));		//(time for the lil man to show)
