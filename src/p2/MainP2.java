...
public class MainP2 {
	public static void main(String[] args) {
		...
		MessageServer messageServer = new MessageServer(messageManager, 2343); //Server start
		MessageClient messageClient1 = new MessageClient("127.0.0.1", 2343); //Client1 start
		...
		MessageClient messageClient2 = new MessageClient("127.0.0.1", 2343); //Client2 start
        ...
        mpClient1.send(TestP2Input.getArrayProducer(5,100));
        mpClient1.send(new ShowGubbe(1000));
